...
?>
    ...
    <?php foreach ($lastPosts as $lastPost): ?>
                <div id="last_posts" class="mt-5 mb-5 text-center">    
                    <h3 id="title_post" class="text-info"><a class=" text-decoration-none" href="post&id=<?=$lastPost['id_post']?>"><?= $lastPost['title_post'] ?></a></h3>
                    <p id="date_posthome">Publié le <?= $lastPost['date_post'] ?></p>
                                          
                    <a id="link_posthome" class="text-decoration-none" href="post&id=<?=$lastPost['id_post']?>">Lire l'article</a>
